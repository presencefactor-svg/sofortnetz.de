...
function selectDevice(name) {
    ...
    suggestionsBox.classList.add('hidden');
    resultDiv.innerHTML = `<span class="text-green-400 font-bold">Evet! ${name} uyumlu.</span>`;
}
...
const GOOGLE_SHEET_URL = "https://docs.google.com/spreadsheets/d/1PVucI5G4wWM4EcoSm0P_H7NBnZQ0Wgks/gviz/tq?tqx=out:csv"; 
const GOOGLE_SHEET_URL_GLOBAL = "https://docs.google.com/spreadsheets/d/1BcTMcXHP5Sj5_d5RjA2DaS6x2UUjTkDv/gviz/tq?tqx=out:csv";
...
function createPlanCard(plan) {
    ...
    div.innerHTML = `
        ...
        <div class="text-xl font-semibold mb-4 text-slate-400">${plan.days} Gün</div>
        ...
        <a href="${plan.stripe_link}" class="btn-primary w-full py-3 rounded-xl font-bold text-white uppercase mt-4 text-lg text-center">Şimdi Satın Alın ve Etkinleştirin</a>
        <div class="text-xs mt-3 ${plan.highlight ? 'text-white/80' : 'text-slate-500'}">QR kodu hemen e-postayla gelir</div>
    `;
    return div;
}
